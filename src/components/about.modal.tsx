		...
		<AnimatePresence>
			{isOpen && (
				<motion.div
					...
					className="absolute top-[var(--header-height)] left-0 z-30 inline-flex h-[calc(100dvh-var(--header-height))] w-screen flex-col items-start justify-between border-black border-r bg-background-primary pt-14 pr-2 pb-6 pl-4 backdrop-blur-sm md:w-[455px]"
				>
